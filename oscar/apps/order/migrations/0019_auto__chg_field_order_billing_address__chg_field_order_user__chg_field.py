...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'order.order': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'orders'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm[AUTH_USER_MODEL]"})
        },
        ...
        u'order.ordernote': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm[AUTH_USER_MODEL]", 'null': 'True'})
        },
        ...
        u'partner.partner': {
            ...
            'users': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'partners'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm[AUTH_USER_MODEL]"})
        },
